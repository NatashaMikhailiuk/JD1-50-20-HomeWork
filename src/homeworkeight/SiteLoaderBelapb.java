 ...
 */
public abstract class SiteLoaderBelapb {
     ...
     */
    protected final double load(String urlToSite, SiteLoaderBelapb.Currency currencyName){
    ...
    public abstract double load(SiteLoaderBelapb.Currency currencyName, String date);
     ...
     * @return курс который мы нашли
     */
    protected abstract double handle(String content, SiteLoaderBelapb.Currency currencyName);
}
